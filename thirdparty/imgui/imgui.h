...
struct ImTextCustomization
{
    ...
    ImTextCustomization& Underline(ImColor col = 0)
    {
        _RangeItem& item = _Ranges.back();
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, const ImTextCustomization* customization = NULL);
...
struct ImFont
{
    ...
    IMGUI_API void              RenderText(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false, const ImTextCustomization* customization = NULL) const;
