...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Customization Simple"))
    {
        ...
        ImGui::TextUnformatted(text, NULL, true, false, &tc.Range(text).TextColor(yellow).Underline(red));
        ...
        ImGui::TextUnformatted(text, NULL, true, false, &tc.Clear().Range(text).Underline());

        ImGui::NewLine();
        ImGui::Text("Underline with color");
        ImGui::TextUnformatted(text, NULL, true, false, &tc.Clear().Range(text).Underline(blue));
    ...
    if (ImGui::TreeNode("Text Customization Combined"))
    {
...

        {
            ...
            ImGui::SameLine();
            ImGui::Checkbox("Text Color", &c.textcolor);
            ImGui::SameLine();
            ...
            ImGui::BeginGroup();
            ImGui::ColorEdit4("Highlight Col_1##1", (float*)&c.hl_col_1, col_flag);
            ImGui::SameLine();
        ...
        if (c.underline)
        {
            style.Range(text + c.ul_1_pos_begin, text + c.ul_1_pos_end).Underline(c.ul_col_1);
            style.Range(text + c.ul_2_pos_begin, text + c.ul_2_pos_end).Underline(c.ul_col_2);
        }
        // strikethrough range
        if (c.strikethrough)
        {
